...
void afteradd(int stock, int item, list mainlist[],int n) {
	for (int i = 0; i < n; i++) {
...
int main() {
	...
	read_filer(filename2, mainlist);
	cout << "List of record:" << endl;
	printlistr(mainlist, n);
	cout << endl;
	...
	while (command != 7) {
		...
		case 3:
			...
			switch (x) {
			case 1:
				sorting_data(mainlist, n, filename, true, filename2);
				cout << "Data sorted!" << endl;
				break;
			case 2:
				sorting_data(mainlist, n, filename, false, filename2);
				cout << "Data sorted!" << endl;
				break;
			case 3:
				sorting_data_number(mainlist, n, filename, true, filename2);
				cout << "Data sorted!" << endl;
				break;
			case 4:
				sorting_data_number(mainlist, n, filename, false, filename2);
				cout << "Data sorted!" << endl;
				break;
			default:
